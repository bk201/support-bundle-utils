...
type SupportBundleInterface interface {
	Create(ctx context.Context, supportBundle *v1alpha1.SupportBundle, opts v1.CreateOptions) (*v1alpha1.SupportBundle, error)
	Update(ctx context.Context, supportBundle *v1alpha1.SupportBundle, opts v1.UpdateOptions) (*v1alpha1.SupportBundle, error)
	UpdateStatus(ctx context.Context, supportBundle *v1alpha1.SupportBundle, opts v1.UpdateOptions) (*v1alpha1.SupportBundle, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha1.SupportBundle, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha1.SupportBundleList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SupportBundle, err error)
...
func newSupportBundles(c *HarvesterV1alpha1Client, namespace string) *supportBundles {
...
func (c *supportBundles) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha1.SupportBundle, err error) {
	result = &v1alpha1.SupportBundle{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *supportBundles) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha1.SupportBundleList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha1.SupportBundleList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("supportbundles").
...
func (c *supportBundles) Create(ctx context.Context, supportBundle *v1alpha1.SupportBundle, opts v1.CreateOptions) (result *v1alpha1.SupportBundle, err error) {
	result = &v1alpha1.SupportBundle{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("supportbundles").
...
func (c *supportBundles) Update(ctx context.Context, supportBundle *v1alpha1.SupportBundle, opts v1.UpdateOptions) (result *v1alpha1.SupportBundle, err error) {
	result = &v1alpha1.SupportBundle{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("supportbundles").
...
func (c *supportBundles) UpdateStatus(ctx context.Context, supportBundle *v1alpha1.SupportBundle, opts v1.UpdateOptions) (result *v1alpha1.SupportBundle, err error) {
	result = &v1alpha1.SupportBundle{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("supportbundles").
...
func (c *supportBundles) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.SupportBundle, err error) {
	result = &v1alpha1.SupportBundle{}
